...
У меня накопилось несколько AI-проектов и идей для контента.

Хотелось иметь единую точку доступа, где можно:

- искать проекты;
- отслеживать их статус;
- хранить идеи для публикаций;
- получать статистику по портфолио.

Для этого был создан Portfolio MCP Assistant.

## Почему MCP

Инструменты вынесены в отдельный MCP-сервер.

Это позволяет использовать одну и ту же бизнес-логику из разных клиентов:
